...
```
 ...
 $ dockerfile="base/Dockerfile.ubuntu-24.04"
 $ date=$(date +"%Y%m%d")
...
| --- | --- | --- |
| `base/ubuntu-24.04` | `base/Dockerfile.ubuntu-24.04` | The "base" image |
| `ci/ubuntu-24.04` | `ci/Dockerfile.ubuntu-24.04` | The image for CI testing |
| `doc/ubuntu-24.04` | `doc/Dockerfile.ubuntu-24.04` | The image for building the official documentation |
