...
def make_all_gitlab_downloads(macroName, version):
    make_gitlab_download("download"+macroName+"Linux", version,
                         "linux-x86_64.tar.gz", "GNU/Linux x86_64")
    make_gitlab_download("download"+macroName+"Darwin", version,
                         "darwin-x86_64.tar.gz", "macOS x86_64")
    make_gitlab_download("download"+macroName+"Mingw", version,
...
def make_doctarball_gitlab_links(name, version, lang):
    make_gitlab_download(macroLang("doctarball"+name, lang), version,
...
make_all_gitlab_downloads("Devel", VERSION_DEVEL)
...
for lang in langs:
    ...
    make_doctarball_gitlab_links("Devel", VERSION_DEVEL, lang)
