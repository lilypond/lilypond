...
%%%%
%%%% Copyright (C) 2001--2023 Rune Zedeler <rune@zedeler.dk>,
...
#`((acousticbassdrum . ,(ly:make-pitch -3 6 NATURAL))
   ...
   (splashhihat . ,(ly:make-pitch -2 4 SHARP))
  ...
  `(
    (drums-style
     . ((acousticbassdrum () #f -3)
        ...
        (splashhihat cross (open . ,DOWN) -5)
        (lowtom () #f -1)
        (openhihat cross (open . ,UP) 3)
