...
// source_location (const Whatever &X), returning the location std::string from X.

// Automatically follow a pointer looking for the source location.
template <class Bearer>
inline std::string source_location (const Bearer *bearer)
{
  return bearer ? source_location (*bearer) : std::string ();
}

template <class LocationBearer>
inline void error (const std::string &s, const LocationBearer &location_bearer)
{
  error (s, source_location (location_bearer));
}

template <class LocationBearer>
inline void programming_error (const std::string &s,
...
template <class LocationBearer>
inline void non_fatal_error (const std::string &s,
                             const LocationBearer &location_bearer)
{
...
template <class LocationBearer>
inline void basic_progress (const std::string &s,
                            const LocationBearer &location_bearer)
{
...
template <class LocationBearer>
inline void progress_indication (const std::string &s, bool newline,
                                 const LocationBearer &location_bearer)
{
...
template <class LocationBearer>
inline void message (const std::string &s, bool newline,
                     const LocationBearer &location_bearer)
{
...
template <class LocationBearer>
inline void debug_output (const std::string &s, bool newline,
                          const LocationBearer &location_bearer)
{
