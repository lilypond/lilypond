...
(define-public median-measure-division-lines-alist
  '(((1) . ())
    ((1/2 1/2) . ((-1 -1 1 1)))
    ((1/4 1/4 1/4 1/4) . ((0 -1 0 1) (-1 0 1 0)))
    ((1/4 3/4) . ((-1 0 0 0) (0 0 0 1)))
    ((1/4 1/4 1/2) . ((-1 0 1 0) (0 0 0 1)))
    ((1/2 1/4 1/4) . ((-1 0 1 0) (0 0 0 -1)))
    ((3/4 1/4) . ((0 -1 0 0) (0 0 1 0)))))

(define-public median-measure-division-chord-placement-alist
  '(((1) . ((0 . 0)))
    ((1/2 1/2) . ((-0.4 . 0.4) (0.4 . -0.4)))
    ((1/4 1/4 1/4 1/4) . ((-0.5 . 0.5) (0.5 . 0.5) (-0.5 . -0.5) (0.5 . -0.5)))
    ((1/4 3/4) . ((-0.5 . 0.5) (0.5 . -0.5)))
    ((1/4 1/4 1/2) . ((-0.5 . 0.5) (0.5 . 0.5) (0 . -0.5)))
    ((1/2 1/4 1/4) . ((0 . 0.5) (-0.5 . -0.5) (0.5 . -0.5)))
    ((3/4 1/4) . ((-0.5 . 0.5) (0.5 . -0.5)))))
...
(define-public (closest-staff-line staff-symbol nhd-staff-pos)
...
list drops the first element of @var{pattern-list}."
  (let* ((relevant-first-elt (car-or-identity (car pattern-list)))
