...
(define paper20-style-sheet-alist
  '(
    ...
    ((2 medium italic roman cmti 12) . "cmti14")
    ((1 medium italic roman cmti 12) . "cmti12")
    ((0 medium italic roman cmti 10) . "cmti10")
    ((-1 medium italic roman cmti 10) . "cmti8")
    ((-2 medium italic roman cmti 10) . "cmti7")
    ((-3 medium italic roman cmti 10) . "cmti6")
    ((3 bold italic dynamic feta 16) . "feta-din16")
    ((2 bold italic dynamic feta 16) . "feta-din16")
    ((1 bold italic dynamic feta 13) . "feta-din13")
    ((0 bold italic dynamic feta 11) . "feta-din11")
    ((-1 bold italic dynamic feta 10) . "feta-din10")
    ((-2 bold italic dynamic feta 8) . "feta-din8")
    ((-3 bold italic dynamic feta 7) . "feta-din7")
