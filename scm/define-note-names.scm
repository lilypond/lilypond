...
;;;;
;;;; Copyright (C) 2010--2026 Valentin Villenave <valentin@villenave.net> et al:
;;;;
;;;; Copyright (C) 1996--2026 Han-Wen Nienhuys <hanwen@xs4all.nl> (Nederlands)
;;;; Copyright (C) 1998--2026 Jaume Obrador <jobrador@ipc4.uib.es> (Catalan)
;;;; Copyright (C) 1997--2026 Roland Meier <meier@informatik.th-darmstadt.de>
;;;;                Bjoern Jacke <bjoern.jacke@gmx.de> (Deutsch)
;;;; Copyright (C) 1996--2026 Han-Wen Nienhuys <hanwen@xs4all.nl> (English)
;;;; Copyright (C) 2002--2026 Carlos García Suárez <cgscqmp@terra.es>
;;;;                Maximiliano G. G. <mxgdvg@yahoo.it> (Espanol)
;;;; Copyright (C) 1998--2026 Paolo Zuliani <zuliap@easynet.it>
;;;;                Eric Wurbel <wurbel@univ-tln.fr> (Italiano)
;;;; Copyright (C) 1998--2026 Arvid Grøtting <arvidg@ifi.uio.no> (Norsk)
;;;; Copyright (C) 2004--2026 Pedro Kröger <kroeger@pedrokroeger.net> (Portugues)
;;;; Copyright (C) 2001--2026 Heikki Junes <heikki.junes@hut.fi> (Suomi)
;;;; Copyright (C) 1997--2026 Mats Bengtsson <mabe@violin.s3.kth.se> (Svenska)
;;;; Copyright (C) 2004--2026 Hendrik Maryns <hendrik.maryns@ugent.be> (Vlaams)
;;;;
...
;; This alist is also looked up reversely for some languages (i.e., a note name
;; is searched for a given pitch using `rassoc`).  To make this work, put all
;; alternative note name spellings after the 'official' ones.
...
(define-session-public language-pitch-names
  `(
    ...
    (deutsch . (
                ...
                ;; invalid entries kept for backward compatibility
                (aeh . ,(ly:make-pitch -1 5 SEMI-FLAT))
                (eeh . ,(ly:make-pitch -1 2 SEMI-FLAT))
                ))
    ...
    (suomi . (
              ...
              ;; invalid entry kept for backward compatibility
