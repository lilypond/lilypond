...
righta = \notes \transpose cis'' {
 ...
 \stemUp \slurUp \tieUp \break
 b4^5( <a8 g>~<a g> a g^4 |
 f4^5 e8^5~e )d4^4 |
 as4^4( <g8 f>~<g f> g^5 f^4 |
 es4^5 d8^5~d )c4^4 |
 ...
 [as,^5 )h,,^2] \clef G [<c8 a^3(> <c16 g^2> c'] <c4. es ges c'^5>~
 <)c8 es ges c'> s4 s8 r16 h^2( c' d' | 
 es' ges-1 f-2 a-1 c'-2 f'-4 \stemUp \tieUp e'-5 d' c' b-4 a^\prall^#'(finger "2-4-3") g |
 )f f'-5( e'-5 d'-4 c'-3 )f'-5 <f4^4 a^5(> <e8^3 g^5> |
 <a,4 f^4> <g,8 e^3> f16^4 d'^5~[d'8. c'16^4] |
 \break 
