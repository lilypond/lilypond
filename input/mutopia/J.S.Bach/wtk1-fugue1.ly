...
%%5
	...
	g4 r4 r2 |
	r1 |
	r8   g8-[ a b]   c8.-[   d32 c ]   b8-[ e ]
%%10
 	 a,-[ d ] ~   d16-[ e  d  c ] b8 r8 r d, |
...
%%20
	...
	g4 ~   g16-[ a bes8] c4   d8-[ g,] |
	 ...
	 e8 a4 g8 ~   g8-[ f g a] |
%%25
 	 bes8.-[  c32 b]   a8-[ d ]   g,-[ c ] ~   c16-[ d  c  bes] |
...
%%5
 	 a,-[ d ] ~   d16-[ e  d  c ]   b8-[ c  ~ c  bes8] |
 	 a-[ d  g, c ] r16   a16-[ b c ] d4 |
	g,4 r8 g8   a-[ b]   c8.-[  d32 c ] |
 	 b8-[ e  a, d ] ~   d16-[ e  d  c!]   b!8-[ e ] ~ |
	e4 d4   c16-[ b c  a]   e'-[  d  c  b] |
%%10
 	 c16-[ a b c ]   d-[  c  b a] g4 r4 |
	r1 |
...
%{
 ...
 This is effective in squeezing it in  more pages, but 1/32nd looks 
 better. Unfortunately, with that configuration, it doesn't
 fit to 2 pages anymore.

%}

       	       SpacingSpanner \set #'common-shortest-duration =  #(ly:make-moment 1 16)
