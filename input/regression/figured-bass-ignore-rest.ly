...
\header {
  texidoc = "When figures appear inside a voice,
  @code{ignoreFiguredBassRest} causes all figures on rests to be discarded
  and all spanners ended.  If set to @code{#f}, figures on rests are
  printed."
}
