...
\header {
  texidoc = "@code{\\propertyUnset} works on a deprecated context property.  The
...
#(ly:expect-warning
  ...
  "deprecatedLyUnsetFn" "skipTypesetting")
...
#(define-deprecated-property
  'translation-type? 'deprecatedLyUnsetFn boolean?
  #:new-symbol 'skipTypesetting)

\fixed c' {
  \set Timing.skipTypesetting = ##t
  R1^"FAIL"
  \propertyUnset Timing.deprecatedLyUnsetFn
  b1
}
