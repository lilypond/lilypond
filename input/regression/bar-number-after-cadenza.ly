...
\header {
  texidoc = "In a measure beginning with cadenza material, if a bar
line is added at the end of the cadenza, its bar number is
parenthesized even though the cadenza does not advance
