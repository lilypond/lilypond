...
LY_DEFINE (ly_duration_dot_count,
           1, 0, 0, (SCM dur),
           R"(
...
LY_DEFINE (ly_duration_2_string,
           1, 0, 0, (SCM dur),
           R"(
...
LY_DEFINE (ly_duration_compress,
