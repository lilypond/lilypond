...
LY_DEFINE (ly_note_head__stem_attachment, "ly:note-head::stem-attachment", 2, 0,
           0, (SCM font_metric, SCM glyph_name),
           ...
           " notehead @var{glyph-name}.")
{
  ...
  return ly_offset2scm (
      Note_head::get_stem_attachment (fm, ly_scm2string (glyph_name)));
}
