...
PREAMBLE_LY = '''%%%% Generated by lilypond-book
...
class MusicXMLFileSnippet (LilypondFileSnippet):
    ...
    def convert_from_musicxml (self):
        ...
        ly_code = self.filter_pipe (self.get_contents(), 'musicxml2ly %s --out=- - ' % opts)
    ...
    def write_ly (self):
        ...
        if os.path.exists (xmlfilename):
            diff_against_existing = self.filter_pipe (self.get_contents(), 'diff -u %s - ' % xmlfilename)
