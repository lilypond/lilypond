...
@code{measure-division-lines-alist} and
@code{measure-division-chord-placement-alist} properties of
...
@code{(@var{x1} @var{y1} @var{x2} @var{y2})}. The
line starts at the point @code{(@var{x1} . @var{y1})} and
ends at @code{(@var{x2} . @var{y2})}.  Coordinates are
expressed in the [-1,@tie{}1] scale relative to the extent of the
square.
