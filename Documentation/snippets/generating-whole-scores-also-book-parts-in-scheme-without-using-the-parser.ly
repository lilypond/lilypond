...
%%
%% Note: this file needs at least LilyPond version 2.27.3.
...
Finally, all you have to do is to pass this score to LilyPond for
...
#(define-public (add-score score)
   (module-define! (current-module) 'toplevel-scores
                   (cons score (module-ref (current-module) 'toplevel-scores '()))))
...
#(define-public (toplevel-book-handler book)
   (map (lambda (score)
        ...
        (reverse (ly:book-lookup book 'toplevel-scores)))
